...
Weixin 4.1.13.12, 4.1.13.65, and 4.1.15.13 store independent serialized key-and-salt values for individual
...
After the exact supported-build database key has passed HMAC validation, a separately
