...
explicitly includes emoticons.

- Plain images, videos, and files are copied unchanged with checksums.
...
- `wxgf` animation containers may be packaged with the custom `application/x-wechat-wxgf` media type; do not claim they are standard GIF/WebP.
